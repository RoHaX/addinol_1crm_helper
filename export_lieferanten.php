<?php
	...
	header('Content-Disposition: attachment; filename=export_lieferanten.csv');
	...
	$strSQL = "SELECT *	FROM accounts WHERE ticker_symbol LIKE '3%' and deleted = 0 ORDER BY ticker_symbol;";

	//print "konto;name;strasse;nation;plz;ort;uid;";
